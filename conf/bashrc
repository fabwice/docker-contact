...
export FLUTTER_ROOT="/Users/zachary.claretscott/flutter"
export EDITOR=nano

#setup commands
alias ginstall='sudo apt-get install git curl zip unzip htop nano ncdu screen sshfs sl cowsay python-minimal -y'
...
alias gq='git commit -m "$(curl -s http://whatthecommit.com/index.txt)"'
alias gy='git add .; git commit -m "$(curl -s https//whatthecommit.com/index.txt)"; git push --all origin'
...
#Prompt commands
alias bashrc='curl -o ~/.bashrc https://gist.githubusercontent.com/hcaz/1f98157bd8ae8c647ffb3ab243d69fc8/raw/.bashrc && . ~/.bashrc'
alias profile='curl -o ~/.profile https://gist.githubusercontent.com/hcaz/1f98157bd8ae8c647ffb3ab243d69fc8/raw/.bashrc && . ~/.profile'
alias space='ncdu'
alias c='clear'
...
alias joke='curl -s -H "Accept: text/plain" https://icanhazdadjoke.com/'
alias weather='curl -s -H "Accept: text/plain" https://wttr.in?format:0'
...
#Some web stuff
alias shell='cd ~/devilbox && sh shell.sh'
...
alias f9='flutter version 1.9.1+hotfix.6'
alias f12='flutter version 1.12.13+hotfix.9'
alias f17='flutter version 1.17.5'
alias fstable='flutter channel stable'
...
qp(){
    ...
    curl --request POST \
      --url 'https://quickprint.probablyrational.com/?data=true' \
      --form code=$qpcode \
      --form content="$1"
}
